...
// Form schemas for each redemption type
...
const redemptionCategories: RedemptionCategory[] = [
  ...
  },
  {
    id: "cash",
    title: "Cash",
    description: "Transfer cash to your bank account",
    icon: Banknote,
  ...
  },
  {
    id: "books",
    title: "Books",
    description: "Get physical or digital books",
    icon: Book,
  ...
  },
  {
    id: "mentorship",
    title: "Mentorship",
    description: "Book a session with our mentors",
    icon: Users,
    color: "from-orange-500 to-red-500",
  },
  {
    id: "courses",
    title: "Pay for Courses",
    description: "Fund your online learning",
    icon: GraduationCap,
  ...
  },
  {
    id: "other",
    title: "Other",
    description: "Custom redemption request",
    icon: MoreHorizontal,
...
export default function Redeem({ balance, onUpdateBalance }: RedeemProps) {
  ...
  const airtimeForm = useForm({
    resolver: zodResolver(airtimeSchema),
    defaultValues: { phoneNumber: "", network: "" },
  });

  const dataForm = useForm({
    resolver: zodResolver(dataSchema),
    defaultValues: { phoneNumber: "", network: "", dataAmount: "" },
  });
  ...
  const booksForm = useForm({
    resolver: zodResolver(booksSchema),
    defaultValues: { deliveryOption: "", address: "", bookCategory: "" },
  });

  const mentorshipForm = useForm({
    resolver: zodResolver(mentorshipSchema),
  });

  const courseForm = useForm({
    resolver: zodResolver(courseSchema),
    defaultValues: { courseName: "", courseLink: "" },
  });
  ...
  const handleSubmit = (data: any, type: string) => {
    console.log(`Redemption request for ${type}:`, data);
    ...
    toast({
      ...
      description: "Your redemption request has been submitted! You will receive confirmation shortly.",
    });
  };
  ...
  const renderForm = () => {
    ...
    const category = redemptionCategories.find(c => c.id === selectedCategory);
          ...
          <Form {...booksForm}>
            <form onSubmit={booksForm.handleSubmit((data) => handleSubmit(data, "books"))} className="space-y-4">
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    <FormLabel>Preferred Book Category</FormLabel>
                    <Select onValueChange={field.onChange} defaultValue={field.value}>
                      <FormControl>
                        <SelectTrigger>
          ...
          <Form {...mentorshipForm}>
            <form onSubmit={mentorshipForm.handleSubmit((data) => handleSubmit(data, "mentorship"))} className="space-y-4">
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    <FormLabel>Mentor Category</FormLabel>
                    <Select onValueChange={field.onChange} defaultValue={field.value}>
                      <FormControl>
                        <SelectTrigger>
                          <SelectValue placeholder="Select mentor category" />
                        </SelectTrigger>
                      </FormControl>
                      <SelectContent>
                        <SelectItem value="business">Business</SelectItem>
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormControl>
                      <Textarea
                        placeholder="Please describe what you would like to redeem for..."
    ...
    >
      ...
      >
        ...
        <p className="text-muted-foreground">
          Choose what you'd like to redeem your Dreams for
        </p>
      </motion.div>
