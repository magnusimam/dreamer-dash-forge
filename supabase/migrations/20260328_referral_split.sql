-- Update referral rewards: referrer gets 100, referred gets 20
...
BEGIN
  ...
  INSERT INTO public.transactions (user_id, type, amount, description)
  VALUES (p_referred_user_id, 'bonus', v_referred_reward, 'Welcome bonus: referred by @' || v_referrer.username);
